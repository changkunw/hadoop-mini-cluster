...
public abstract class FSEditLogOp {
    ...
    public long getTransactionId() {
        boolean expression = txid != HdfsServerConstants.INVALID_TXID;
        if(!expression){
            System.out.println(txid + " wo ri");
            System.out.println(HdfsServerConstants.INVALID_TXID + "  fuck");
        }
    ...
    static class UpdateMasterKeyOp extends FSEditLogOp {
        ...
        public void writeFields(DataOutputStream out) throws IOException {
            if (key != null) {
                ...
                System.out.println("mlgbbbbbbbbbbbbbbbbbbbbb");
            }
        }
    ...
    static class CreateSnapshotOp extends FSEditLogOp {
        ...
        @Override
        public void writeFields(DataOutputStream out) throws IOException {
            if (null != snapshotName && null != snapshotRoot) {
    ...
    static class DeleteSnapshotOp extends FSEditLogOp {
        ...
        @Override
        public void writeFields(DataOutputStream out) throws IOException {
            if (snapshotName != null && snapshotRoot != null) {
                FSImageSerialization.writeString(snapshotRoot, out);
                FSImageSerialization.writeString(snapshotName, out);
                writeRpcIds(rpcClientId, rpcCallId, out);
            }
    ...
    static class RenameSnapshotOp extends FSEditLogOp {
        ...
        @Override
        public void writeFields(DataOutputStream out) throws IOException {
            if (snapshotNewName != null && snapshotOldName != null && snapshotRoot != null) {
                FSImageSerialization.writeString(snapshotRoot, out);
