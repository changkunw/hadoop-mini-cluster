...
public class FSEditLogLoader {
     ...
     * along.
     */
    long loadFSEditsSync(EditLogInputStream edits, long expectedStartingTxId,
                         StartupOption startOpt, MetaRecoveryContext recovery) throws IOException {
        StartupProgress prog = NameNode.getStartupProgress();
        Step step = createStartupProgressStep(edits);
        prog.beginStep(Phase.LOADING_EDITS, step);
        ...
        try {
            long startTime = monotonicNow();
            FSImage.LOG.info("Start loading edits file " + edits.getName());
            long numEdits = loadEditRecordsSync(edits, false, expectedStartingTxId,
                                                startOpt, recovery);
            FSImage.LOG.info("Edits file " + edits.getName()
                             + " of size " + edits.length() + " edits # " + numEdits
                             + " loaded in " + (monotonicNow() - startTime) / 1000 + " seconds");
    ...
    long loadEditRecordsSync(EditLogInputStream in, boolean closeOnExit,
                ...
                try {
                    ...
                    try {
                        ...
                        if (op.hasTransactionId()) {
                            op.setTransactionId(expectedTxId);
                        }
                    } catch (Throwable e) {
                    ...
                    try {
                        try {
                            long inodeId = applyEditLogOpSync(op, fsDir, startOpt, in.getVersion(true), lastInodeId);
    ...
    private long applyEditLogOpSync(FSEditLogOp op, FSDirectory fsDir,
        ...
        switch (op.opCode) {
            case OP_ADD: {
                ...
                fsNamesys.getEditLog().logEditSync(op);
                break;
            }
            case OP_CLOSE: {
                AddCloseOp addCloseOp = (AddCloseOp) op;
            ...
            case OP_UPDATE_BLOCKS: {
                ...
                fsNamesys.getEditLog().logEditSync(updateOp);
                break;
            }
            case OP_ADD_BLOCK: {
                ...
                fsNamesys.getEditLog().logEditSync(addBlockOp);
                break;
            }
            case OP_SET_REPLICATION: {
                ...
                fsNamesys.getEditLog().logEditSync(setReplicationOp);
                break;
            }
            case OP_CONCAT_DELETE: {
                ...
                fsNamesys.getEditLog().logEditSync(concatDeleteOp);
                break;
            }
            case OP_RENAME_OLD: {
                ...
                fsNamesys.getEditLog().logEditSync(renameOp);
                break;
            }
            case OP_DELETE: {
                ...
                if (deleteOp.path != null) {
                    fsNamesys.getEditLog().logEditSync(deleteOp);
                }
                break;
            }
            case OP_MKDIR: {
                ...
                inodeId = getAndUpdateLastInodeId(mkdirOp.inodeId, logVersion,
                                                  lastInodeId);
                if (mkdirOp.path != null) {
                    System.out.println("mkdir is : " + mkdirOp.path);
                    ...
                    fsNamesys.getEditLog().logEditSync(mkdirOp);
                }
            ...
            case OP_SET_GENSTAMP_V1: {
                ...
                fsNamesys.getEditLog().logEditSync(setGenstampV1Op);
                break;
            }
            case OP_SET_PERMISSIONS: {
                ...
                fsNamesys.getEditLog().logEditSync(setPermissionsOp);
                break;
            }
            case OP_SET_OWNER: {
                ...
                fsNamesys.getEditLog().logEditSync(setOwnerOp);
                break;
            }
            case OP_SET_NS_QUOTA: {
                ...
                fsNamesys.getEditLog().logEditSync(setNSQuotaOp);
                break;
            }
            case OP_CLEAR_NS_QUOTA: {
                ...
                fsNamesys.getEditLog().logEditSync(clearNSQuotaOp);
                break;
            }
            case OP_SET_QUOTA: {
                ...
                fsNamesys.getEditLog().logEditSync(setQuotaOp);
                break;
            }
            case OP_SET_QUOTA_BY_STORAGETYPE: {
                ...
                fsNamesys.getEditLog().logEditSync(setQuotaByStorageTypeOp);
                break;
            }
            case OP_TIMES: {
                ...
                fsNamesys.getEditLog().logEditSync(timesOp);
                break;
            }
            case OP_SYMLINK: {
                ...
                fsNamesys.getEditLog().logEditSync(symlinkOp);
                break;
            }
            case OP_RENAME: {
            ...
            case OP_GET_DELEGATION_TOKEN: {
                ...
                fsNamesys.getEditLog().logEditSync(getDelegationTokenOp);
                break;
            }
            case OP_RENEW_DELEGATION_TOKEN: {
                ...
                fsNamesys.getEditLog().logEditSync(renewDelegationTokenOp);
                break;
            }
            case OP_CANCEL_DELEGATION_TOKEN: {
                ...
                fsNamesys.getEditLog().logEditSync(cancelDelegationTokenOp);
                break;
            }
            case OP_UPDATE_MASTER_KEY: {
                ...
                if (updateMasterKeyOp.key != null) {
                    fsNamesys.getEditLog().logEditSync(updateMasterKeyOp);
                } else {
                    System.out.println("caonidaye............................");
                }
                break;
            }
            case OP_REASSIGN_LEASE: {
                ...
                fsNamesys.reassignLeaseInternal(lease, reassignLeaseOp.newHolder,
                                                pendingFile);
                fsNamesys.getEditLog().logEditSync(reassignLeaseOp);
                break;
            }
            ...
            case OP_CREATE_SNAPSHOT: {
                ...
                fsNamesys.getEditLog().logEditSync(createSnapshotOp);
                break;
            }
            case OP_DELETE_SNAPSHOT: {
                ...
                fsNamesys.getEditLog().logEditSync(deleteSnapshotOp);
                break;
            }
            case OP_RENAME_SNAPSHOT: {
                ...
                fsNamesys.getEditLog().logEditSync(renameSnapshotOp);
                break;
            }
            case OP_ALLOW_SNAPSHOT: {
                ...
                fsNamesys.getSnapshotManager().setSnapshottable(
                        snapshotRoot, false);
                fsNamesys.getEditLog().logEditSync(allowSnapshotOp);
                break;
            }
            case OP_DISALLOW_SNAPSHOT: {
                ...
                fsNamesys.getSnapshotManager().resetSnapshottable(
                        snapshotRoot);
                fsNamesys.getEditLog().logEditSync(disallowSnapshotOp);
                break;
            }
            case OP_SET_GENSTAMP_V2: {
                ...
                fsNamesys.getEditLog().logEditSync(setGenstampV2Op);
                break;
            }
            case OP_ALLOCATE_BLOCK_ID: {
                ...
                fsNamesys.getEditLog().logEditSync(allocateBlockIdOp);
                break;
            }
            ...
            case OP_ADD_CACHE_DIRECTIVE: {
                ...
                fsNamesys.getEditLog().logEditSync(addOp);
                break;
            }
            case OP_MODIFY_CACHE_DIRECTIVE: {
                ...
                fsNamesys.getEditLog().logEditSync(modifyOp);
                break;
            }
            case OP_REMOVE_CACHE_DIRECTIVE: {
                ...
                fsNamesys.getEditLog().logEditSync(removeOp);
                break;
            }
            ...
            case OP_SET_ACL: {
                ...
                fsNamesys.getEditLog().logEditSync(setAclOp);
                break;
            }
            case OP_SET_XATTR: {
                ...
                fsNamesys.getEditLog().logEditSync(setXAttrOp);
                break;
            }
            case OP_REMOVE_XATTR: {
                ...
                fsNamesys.getEditLog().logEditSync(removeXAttrOp);
                break;
            }
            case OP_TRUNCATE: {
                ...
                fsNamesys.getEditLog().logEditSync(truncateOp);
                break;
            }
            case OP_SET_STORAGE_POLICY: {
                ...
                fsNamesys.getEditLog().logEditSync(setStoragePolicyOp);
                break;
            }
            default:
