...
public class NameNodeAdapter {
  ...
  public static LeaseManager.Lease getLeaseForPath(NameNode nn, String path) {
  ...
  public static String getLeaseHolderForPath(NameNode namenode, String path) {
    LeaseManager.Lease l = getLeaseForPath(namenode, path);
  ...
  public static long getLeaseRenewalTime(NameNode nn, String path) {
    LeaseManager.Lease l = getLeaseForPath(nn, path);
